...
% Perform test
% Numerical approach
[Br_num, Bz_num, Br_tot_num, Bz_tot_num] = B_field(coord_B, coord_ext, c, 'numerical', n);
...
% Perform test
% Elliptic integral
[Br_ell, Bz_ell, Br_tot_ell, Bz_tot_ell] = B_field(coord_B, coord_ext, c, 'analytical', n);
